...
namespace Rascateer.TopDownGame
{
    public static class Game
    {
        ...
        public static CommandSystem Commands { [MethodImpl(MethodImplOptions.AggressiveInlining)] get; set; }
        public static ConfigurationManager Configuration { [MethodImpl(MethodImplOptions.AggressiveInlining)] get; private set; }
